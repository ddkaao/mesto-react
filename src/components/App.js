    ...
    <div className="container">
        <div className="page">
            ...
            <PopupWithForm title='Обновить аватар' name='avatar' isOpen={isEditAvatarPopupOpen} onClose={closeAllPopups}>
                ...
                <button type="submit" className="popup__submit-btn popup__submit-btn_avatar">Сохранить</button>
            </PopupWithForm>
            ...
            <PopupWithForm title='Редактировать профиль' name='edit' isOpen={isEditProfilePopupOpen} onClose={closeAllPopups}>
                ...
                <button type="submit" className="popup__submit-btn popup__submit-btn_save">Сохранить</button>
            </PopupWithForm>
            ...
            <PopupWithForm title='Новое место' name='add' isOpen={isAddPlacePopupOpen} onClose={closeAllPopups}>
                ...
                <button type="submit" className="popup__submit-btn popup__submit-btn_create">Создать</button>
            </PopupWithForm>
